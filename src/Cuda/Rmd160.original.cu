...
__device__ static byte PADDING[64] = {
...
* of bytes.
*/
__device__ void RMD160Update (RMD160_CTX *ctx, const unsigned char *input, unsigned __int32 lenArg)
{
...
*/
__device__ static void RMD160Pad(RMD160_CTX *ctx)
{
	byte count[8];
	uint32 padlen;
...
__device__ static word32 rotlFixed (word32 x, unsigned int y)
{
...
__device__ void RMD160Transform (unsigned __int32 *digest, const unsigned __int32 *data)
{
...
__device__ static const byte OrderTab[] = {
...
__device__ static const byte RolTab[] = {
...
__device__ static const uint32 KTab[] = {
	0x00000000UL,
	0x5A827999UL,
	0x6ED9EBA1UL,
	0x8F1BBCDCUL,
